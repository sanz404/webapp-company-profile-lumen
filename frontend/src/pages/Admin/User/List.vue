        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="clearfix mb-4">
                    <router-link to="/admin/user/create" data-bs-toggle="tooltip" data-bs-placement="top" title="Create New" class="btn btn-success float-end">
                        <i class="fas fa-plus"></i>&nbsp;Create New
                    </router-link>
                </div>
                <table class="table table-striped" id="table-user" @click="onClick">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Username</th>
    ...
    export default {
        ...
        methods:{
            ...
            showDataTable: function(){
                let element = "#table-user";
                let url = `${process.env.VUE_APP_SERVICE}/main/users/list`;
                let  columns = [
                    {
                        "data": "id",
                        "orderable": false,
