             ...
             <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly class="form-control-plaintext" v-model="contact.name" />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label  class="col-sm-2 col-form-label">Email </label>
                        <div class="col-sm-10">
                             <input type="text" readonly class="form-control-plaintext" v-model="contact.email"  />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label  class="col-sm-2 col-form-label">Phone </label>
                        <div class="col-sm-10">
                           <input type="text" readonly class="form-control-plaintext" v-model="contact.phone"  />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label  class="col-sm-2 col-form-label">Website</label>
                        <div class="col-sm-10">
                             <input type="text" readonly class="form-control-plaintext" v-model="contact.website"  />
                        </div>
                    </div>
                     <div class="row mb-3">
                        <label  class="col-sm-2 col-form-label">Address </label>
                        <div class="col-sm-10">
                             <input type="text" readonly class="form-control-plaintext" v-model="contact.address"  />
                        </div>
                    </div>
                </div>
