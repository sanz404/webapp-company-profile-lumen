                ...
                <div class="card-body">
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                             <template v-if="project.image">
                                <img :src="this.backendURL+'/uploads/'+project.image" class="img-thumbnail" width="400" />
                            </template>
                            <template v-else>
                    ...
                    <template v-if="project.category">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" readonly class="form-control-plaintext" v-model="project.category.name" />
                            </div>
                        </div>
                    </template>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly class="form-control-plaintext" v-model="project.name" />
                        </div>
                    </div>
                     <div class="row mb-3">
                        <label  class="col-sm-2 col-form-label">Description </label>
                        <div class="col-sm-10">
                            <input type="text" readonly class="form-control-plaintext" v-model="project.description" />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label  class="col-sm-2 col-form-label">Status</label>
                        <div class="col-sm-10">
                             <input type="text" readonly class="form-control-plaintext" v-model="project_status"  />
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        computed: {
            ...mapState({
                ...
                project_status: state=> parseInt(state.project.data.is_published) === 1 ? 'Published' : 'Draft'
            })
        },
        created() {
            this.alert.message = ''  
