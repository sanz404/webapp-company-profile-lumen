        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="clearfix mb-4">
                    <router-link to="/admin/team/create" data-bs-toggle="tooltip" data-bs-placement="top" title="Create New" class="btn btn-success float-end">
            ...
            onClick(e) {
                if(e.target.dataset && e.target.dataset.id){
                    ...
                    if (e.target.classList.contains('btn-view')) {
                        this.$router.push({ path: '/admin/team/detail/'+id});
                    }
                    if (e.target.classList.contains('btn-edit')) {
                        this.$router.push({ path: '/admin/team/edit/'+id});
                    }
