        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="clearfix mb-4">
                    <router-link to="/admin/content/create" data-bs-toggle="tooltip" data-bs-placement="top" title="Create New" class="btn btn-success float-end">
                        <i class="fas fa-plus"></i>&nbsp;Create New
                    </router-link>
                </div>
                <table class="table table-striped" id="table-content" @click="onClick">
                    <thead>
                        <tr>
                            <th>#</th>
    ...
    export default {
        ...
        methods:{
            ...
            showDataTable: function(){
                let element = "#table-content";
                let url = `${process.env.VUE_APP_SERVICE}/main/contents/list`;
                let  columns = [
                    {
                        "data": "id",
                        "orderable": false,
            ...
            onClick(e) {
                if(e.target.dataset && e.target.dataset.id){
                    ...
                    if (e.target.classList.contains('btn-view')) {
                        this.$router.push({ path: '/admin/content/detail/'+id});
                    }
                    if (e.target.classList.contains('btn-edit')) {
                        this.$router.push({ path: '/admin/content/edit/'+id});
                    }
