                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                           ...
                           <span v-if="file_error" class="invalid-feedback"> {{ file_error_message }} </span>
                            <template v-if="product.image && (product.image).length === 40">
                                <h1></h1>
                                <img :src="this.backendURL+'/uploads/'+product.image" class="img-thumbnail" width="250" />
                            </template>
                            <template v-else>
                                <h1></h1>
        ...
        methods: {
            ...
            handleSubmit(e) {
                ...
                if (!this.v$.product.$error) {
                    const { product, param } = this;
                    this.updateProduct({ product, param })
                } 
            },
             handleFileUpload(e){
                if(e.target.files){
