               ...
               <div class="card-body">
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                           ...
                           <template v-if="article.image && (article.image).length === 40">
                                <h1></h1>
                                <img :src="this.backendURL+'/uploads/'+article.image" class="img-thumbnail" width="250" />
                            </template>
                            <template v-else>
                                <h1></h1>
                                <template v-if="article.image">
                                    <img :src="article.image" class="img-thumbnail" width="250" />
                                </template>
                                <template v-else>
        ...
        methods: {
            ...
            handleSubmit(e) {
                ...
                if (!this.v$.article.$error) {
                    const { article, param } = this;
                    this.updateArticle({ article, param })
                } 
            },
           handleFileUpload(e){
                if(e.target.files){
