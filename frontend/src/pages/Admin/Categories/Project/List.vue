        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="clearfix mb-4">
                    <router-link to="/admin/categories/project/create" data-bs-toggle="tooltip" data-bs-placement="top" title="Create New" class="btn btn-success float-end">
                        <i class="fas fa-plus"></i>&nbsp;Create New
                    </router-link>
                </div>
                <table class="table table-striped" id="table-category-project" @click="onClick">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Name</th>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...mapActions('categoryProject', ['delete']),
            ...mapActions({
            ...
            showDataTable: function(){
                let element = "#table-category-project";
                let url = `${process.env.VUE_APP_SERVICE}/main/categories/project/list`;
                let  columns = [
                    {
                        "data": "id",
                        "orderable": false,
            ...
            onClick(e) {
                if(e.target.dataset && e.target.dataset.id){
                    ...
                    if (e.target.classList.contains('btn-view')) {
                        this.$router.push({ path: '/admin/categories/project/detail/'+id});
                    }
                    if (e.target.classList.contains('btn-edit')) {
                        this.$router.push({ path: '/admin/categories/project/edit/'+id});
                    }
